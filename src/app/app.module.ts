...
import { DataTableHistoricoComponent } from "./views/historico/data-table-historico/data-table-historico.component";

import { DialogDetalheHistorico } from "./views/historico/data-table-historico/dialog-detalhe-agendamento/dialog-detalhe-agendamento.component";
...
@NgModule({
  ...
  entryComponents: [DialogDetalheHistorico],
